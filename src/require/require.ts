...
export async function loadRequire(context: ModulesPlugin): Promise<void> {
  const {
    ...
    transpiles = [new MarkdownTranspile(context, tsTranspile), tsTranspile],
...
function createRequire(
  ...
  const ret: Require = Object.assign(
    (id0: string, opts?: RequireOptions) => {
          ...
          new self0.Function(
            ...
            compiledSyncCode ??
              attachFunctionSourceMap(
                ...
                {
                  deletions: PRECOMPILE_SYNC_PREFIX.split("").map(
                    (_0, idx) => ({
                      column: idx,
                      line: 1,
                    }),
              ...
              if (key === "esModuleWithCommonJS") {
                ...
                ret2 = new Proxy(exports, {
                  ...
                  getOwnPropertyDescriptor(
                    ...
                    if (
                      ret3 &&
                      !(ret3.configurable ?? true) &&
                      !Reflect.defineProperty(target, property, ret3)
                    ) {
                      ret3 = void 0;
                    }
                    return (
                      ret3 ?? Reflect.getOwnPropertyDescriptor(target, property)
                    );
                  },
                  // eslint-disable-next-line @typescript-eslint/no-unused-vars
                  getPrototypeOf(_target): object | null {
